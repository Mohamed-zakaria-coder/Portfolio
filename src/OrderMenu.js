    ...
    <div className='menu-container'>
      ...
      <div className='menu-content'>
        <div className='each-order'>
          ...
          <div>
            <div className='total-each-price'>
              <span className='quantity'>x2</span>$20</div>
          </div>
        ...
        <div className='each-order'>
          ...
          <div>
            <div className='total-each-price'>
              <span className='quantity'>x1</span>$32</div>
          </div>
        ...
        <div className='each-order'>
          ...
          <div>
            <div className='total-each-price'>
              <span className='quantity'>x3</span>$45</div>
          </div>
        ...
        <div className='each-order'>
          ...
          <div>
            <div className='total-each-price'>
              <span className='quantity'>x1</span>$23</div>
          </div>

        </div>
        <div className='total-price-container'>
          <h4 className='total-price-title'>ٍSub Total
          </h4>
